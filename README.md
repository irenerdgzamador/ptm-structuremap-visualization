...
1. Place `quant_pgm_NM_LIMMA.tsv` in `data/raw/`
2. Create and activate the Python 3.8 environment
3. Install requirements: `pip install -r requirements.txt`
4. Run preprocessing:
   - Terminal: `python run_preprocessing.py`
   - or Notebook: `01_build_ptm_table.ipynb`
5. Run StructureMap: `02_run_structuremap.ipynb`
6. Generate plots: `03_plots.ipynb`
